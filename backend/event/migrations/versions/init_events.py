...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('latitude', sa.Numeric(precision=20, scale=16), nullable=True),
        sa.Column('longitude', sa.Numeric(precision=20, scale=16), nullable=True),
        sa.Column('checkin_radius_meters', sa.Numeric(precision=12, scale=2), nullable=True),
